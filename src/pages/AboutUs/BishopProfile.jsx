                ...
                <div className="section-inner">
                    <div className="container">
                        <div className="section-heading">
                            <h2 className="mb-4 text-center">Bishop Profile</h2>
                        </div>
                        <div className="row">
                            <div className="tabSection">
                                <ul className="nav nav-pills" role="tablist">
                                    ...
                                    <li role="presentation" className={`category-link ${activeTab === 'study1' ? 'active' : ''}`}>
                                        <a
                                            href="/"
                                            ...
                                            data-toggle="tab"
                                        >
                                            <p className="hidden-xs text-black">Studies <i className="fa fa-book"></i></p>
                                        </a>
                                    </li>
                                    <li role="presentation" className={`category-link ${activeTab === 'offices2' ? 'active' : ''}`}>
                                        <a
                                            href="/"
                                            ...
                                            data-toggle="tab"
                                        >
                                            <p className="hidden-xs text-black">Offices <i className="fa fa-building"></i></p>
                                        </a>
                                    </li>
                                    <li role="presentation" className={`category-link ${activeTab === 'publication3' ? 'active' : ''}`}>
                                        <a
                                            href="/"
                                            ...
                                            data-toggle="tab"
                                        >
                                            <p className="hidden-xs text-black">Publications <i className="fa fa-book"></i></p>
                                        </a>
                                    </li>
                                </ul>
                                                        ...
                                                        <table className="table table-bordered">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td>2010-2014</td>
                                                                    <td>Vice Chairman</td>
                                                                    <td>APBC Commission for Catholic Education</td>
                                                                </tr>
                                                                <tr>
                                                                    <td>2015-2021</td>
                                                                    <td>Asst. General</td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>Rector</td>
                                                                    <td>
                                                                        Seminarium Missionum, Teresianum, Rome; Visiting professor at Marianum
                                                                        and Teresianum, Pontifical Institutes
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Feb. 2022 - Present</td>
                                                                    <td>Bishop of Kurnool</td>
                                                                    <td>Currently pursuing second doctorate in Spiritual Theology</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    </div>
                                                    ...
                                                    <div className="table-responsive">
                                                        <table className="table table-bordered">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td>Telugu</td>
                                                                    <td>Series on Carmelite Spirituality (5 volumes)</td>
                                                                    <td>
                                                                        Includes "Paripurnatha Margamu," translation with commentary on "The
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        An exegetical and theological commentary on some parables of Luke,
                                                                        published by St. Paul’s in 2022
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
